...
<img width="300" height="216" alt="image" src="https://github.com/user-attachments/assets/713ad958-4887-44f0-bf30-3233b4e2db10" />
...
<img width="306" height="225" alt="image" src="https://github.com/user-attachments/assets/b81120c9-8b80-46db-b027-7088771fbb79" />
...
public class Main {
    public static void main(String[] args) {
        ...
        Map<String, Boolean> isRainbow = new HashMap<>();
        ...
        for (int i = 0; i < N; i++) {
            ...
            if (user1.equals("ChongChong") || user2.equals("ChongChong")){
                isRainbow.put(user1, true);
                isRainbow.put(user2, true);
            }

            if (!isRainbow.containsKey(user1)){
                isRainbow.put(user1, false);
            } else {
                if (isRainbow.get(user1).equals(true)){
                    isRainbow.put(user1, true);
                    isRainbow.put(user2, true);
                }
            }

            if (!isRainbow.containsKey(user2)){
                isRainbow.put(user2, false);
            } else {
                if (isRainbow.get(user2).equals(true)){
                    isRainbow.put(user1, true);
                    isRainbow.put(user2, true);
                }
            }
        ...
        for (Boolean value : isRainbow.values()) {
            if (value){
                cnt++;
            }
        }
